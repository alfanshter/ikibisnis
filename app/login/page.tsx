    ...
    <div className="min-h-screen bg-slate-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-linear-to-br from-slate-900 via-blue-950 to-slate-900 flex-col items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <h1 className="text-4xl font-bold text-white mb-3 tracking-tight">Nexus Admin</h1>
        ...
        {/* Bottom decoration */}
        <p className="absolute bottom-8 text-slate-600 text-xs">© 2026 Nexus Admin. All rights reserved.</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <span className="text-white font-bold text-xl">Nexus Admin</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-800/60 border border-slate-700/60 hover:border-slate-600/80 focus:border-blue-500/70 focus:ring-1 focus:ring-blue-500/30 text-white text-sm placeholder-slate-500 rounded-xl pl-10 pr-4 py-3 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-slate-800/60 border border-slate-700/60 hover:border-slate-600/80 focus:border-blue-500/70 focus:ring-1 focus:ring-blue-500/30 text-white text-sm placeholder-slate-500 rounded-xl pl-10 pr-11 py-3 outline-none transition-all"
                />
                <button
                  type="button"
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              <span className="text-slate-400 text-sm">Ingat saya di perangkat ini</span>
            </label>
