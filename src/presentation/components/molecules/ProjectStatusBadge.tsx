 ...
 * Status pill for project status (Baru / Pending / Proses / Selesai / Dibayar / Dibatalkan).
 */
'use client';
...
const MAP: Record<ProjectStatus, { dot: string; text: string; bg: string }> = {
  ...
  'Pending':    { dot: 'bg-orange-400',  text: 'text-orange-300',  bg: 'bg-orange-500/10 border border-orange-500/20'   },
